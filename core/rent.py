...
from core.ssb import get_city_m2_month  # kr/m² per MND for (by, segment)
...
def _load_table(
    ...
    """Laster data/rent_m2.csv inn i et nestet dict."""
...
def _load_oslo_postnr_exact(
    path: str = "data/postnr/oslo_postnr.csv",
...
def _load_oslo_prefix2(path: str = "data/postnr/oslo_prefix.csv") -> Dict[str, str]:
    m: Dict[str, str] = {}
    if not os.path.exists(path):
        return m
    with open(path, "r", encoding="utf-8") as f:
