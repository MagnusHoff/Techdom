...
def _safe_add(module_name: str, class_name: str):
    """
    Importerer modul og klasse hvis de finnes; instansierer og legger i DRIVERS.
    Logger (valgfritt) korte feil dersom import feiler, så du oppdager at en driver
    ikke ble lastet i utviklingsmiljø.
    """
    try:
